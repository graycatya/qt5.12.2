...
include(/usr/local/qt5.12.2/mkspecs/modules-inst/qt_lib_sql.pri)
QT.sql.priority = 1
include(/usr/local/qt5.12.2/mkspecs/modules-inst/qt_lib_sql_private.pri)
QT.sql_private.priority = 1
