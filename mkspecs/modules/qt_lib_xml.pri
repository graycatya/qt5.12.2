...
include(/usr/local/qt5.12.2/mkspecs/modules-inst/qt_lib_xml.pri)
QT.xml.priority = 1
include(/usr/local/qt5.12.2/mkspecs/modules-inst/qt_lib_xml_private.pri)
QT.xml_private.priority = 1
