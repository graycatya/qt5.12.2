...
include(/usr/local/qt5.12.2/mkspecs/modules-inst/qt_lib_dbus.pri)
QT.dbus.priority = 1
include(/usr/local/qt5.12.2/mkspecs/modules-inst/qt_lib_dbus_private.pri)
QT.dbus_private.priority = 1
