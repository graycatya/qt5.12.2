...
void QQuickWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickWidget::*)(QQuickWidget::Status );
        ...
        {
            using _t = void (QQuickWidget::*)(QQuickWindow::SceneGraphError , const QString & );
...
QT_INIT_METAOBJECT const QMetaObject QQuickWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_QQuickWidget.data,
    qt_meta_data_QQuickWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
