...
#include "../util/qquicktransition_p.h"
...
void QQuickTransition::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickTransition *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickTransition::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickTransition::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickTransition.data,
    qt_meta_data_QQuickTransition,
    qt_static_metacall,
    nullptr,
    nullptr
} };
