...
#include "../items/qquickwindowmodule_p.h"
...
void QQuickWindowQmlImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickWindowQmlImpl *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickWindowQmlImpl::*)(bool );
        ...
        {
            using _t = void (QQuickWindowQmlImpl::*)(QWindow::Visibility );
        ...
        {
            using _t = void (QQuickWindowQmlImpl::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickWindowQmlImpl::staticMetaObject = { {
    &QQuickWindow::staticMetaObject,
    qt_meta_stringdata_QQuickWindowQmlImpl.data,
    qt_meta_data_QQuickWindowQmlImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
