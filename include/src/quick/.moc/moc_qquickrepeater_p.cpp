...
#include "../items/qquickrepeater_p.h"
...
void QQuickRepeater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickRepeater *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickRepeater::*)(int , QQuickItem * );
...
QT_INIT_METAOBJECT const QMetaObject QQuickRepeater::staticMetaObject = { {
    &QQuickItem::staticMetaObject,
    qt_meta_stringdata_QQuickRepeater.data,
    qt_meta_data_QQuickRepeater,
    qt_static_metacall,
    nullptr,
    nullptr
} };
