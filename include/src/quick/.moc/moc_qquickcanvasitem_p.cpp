...
#include "../items/context2d/qquickcanvasitem_p.h"
...
void QQuickCanvasItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickCanvasItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickCanvasItem::*)(const QRect & );
        ...
        {
            using _t = void (QQuickCanvasItem::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickCanvasItem::staticMetaObject = { {
    &QQuickItem::staticMetaObject,
    qt_meta_stringdata_QQuickCanvasItem.data,
    qt_meta_data_QQuickCanvasItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject QQuickContext2DRenderThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_QQuickContext2DRenderThread.data,
    qt_meta_data_QQuickContext2DRenderThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
