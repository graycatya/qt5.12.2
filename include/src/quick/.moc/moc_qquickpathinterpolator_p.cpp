...
#include "../util/qquickpathinterpolator_p.h"
...
void QQuickPathInterpolator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickPathInterpolator *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickPathInterpolator::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickPathInterpolator::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickPathInterpolator.data,
    qt_meta_data_QQuickPathInterpolator,
    qt_static_metacall,
    nullptr,
    nullptr
} };
