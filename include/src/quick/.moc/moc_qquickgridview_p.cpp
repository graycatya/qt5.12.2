...
#include "../items/qquickgridview_p.h"
...
void QQuickGridView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickGridView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickGridView::staticMetaObject = { {
    &QQuickItemView::staticMetaObject,
    qt_meta_stringdata_QQuickGridView.data,
    qt_meta_data_QQuickGridView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject QQuickGridViewAttached::staticMetaObject = { {
    &QQuickItemViewAttached::staticMetaObject,
    qt_meta_stringdata_QQuickGridViewAttached.data,
    qt_meta_data_QQuickGridViewAttached,
    qt_static_metacall,
    nullptr,
    nullptr
} };
