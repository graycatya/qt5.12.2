...
#include "../designer/qquickdesignerwindowmanager_p.h"
...
QT_INIT_METAOBJECT const QMetaObject QQuickDesignerWindowManager::staticMetaObject = { {
    &QSGRenderLoop::staticMetaObject,
    qt_meta_stringdata_QQuickDesignerWindowManager.data,
    qt_meta_data_QQuickDesignerWindowManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
