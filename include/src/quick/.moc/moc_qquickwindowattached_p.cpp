...
void QQuickWindowAttached::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickWindowAttached *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickWindowAttached::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickWindowAttached::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickWindowAttached.data,
    qt_meta_data_QQuickWindowAttached,
    qt_static_metacall,
    qt_meta_extradata_QQuickWindowAttached,
    nullptr
} };
