...
QT_INIT_METAOBJECT const QMetaObject QQuickAnimatorController::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickAnimatorController.data,
    qt_meta_data_QQuickAnimatorController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QQuickAnimatorController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QAnimationJobChangeListener"))
        return static_cast< QAnimationJobChangeListener*>(this);
