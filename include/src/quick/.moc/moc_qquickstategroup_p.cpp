...
#include "../util/qquickstategroup_p.h"
...
void QQuickStateGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickStateGroup *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickStateGroup::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject QQuickStateGroup::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickStateGroup.data,
    qt_meta_data_QQuickStateGroup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
