...
#include "../items/qquickloader_p.h"
...
void QQuickLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickLoader *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickLoader::staticMetaObject = { {
    &QQuickImplicitSizeItem::staticMetaObject,
    qt_meta_stringdata_QQuickLoader.data,
    qt_meta_data_QQuickLoader,
    qt_static_metacall,
    nullptr,
    nullptr
} };
