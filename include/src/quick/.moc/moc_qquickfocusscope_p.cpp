...
#include "../items/qquickfocusscope_p.h"
...
QT_INIT_METAOBJECT const QMetaObject QQuickFocusScope::staticMetaObject = { {
    &QQuickItem::staticMetaObject,
    qt_meta_stringdata_QQuickFocusScope.data,
    qt_meta_data_QQuickFocusScope,
    qt_static_metacall,
    nullptr,
    nullptr
} };
