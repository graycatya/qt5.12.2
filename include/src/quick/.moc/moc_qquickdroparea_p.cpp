...
#include "../items/qquickdroparea_p.h"
...
void QQuickDropEvent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickDropEvent *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickDropEvent::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickDropEvent.data,
    qt_meta_data_QQuickDropEvent,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickDropAreaDrag *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickDropAreaDrag::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickDropAreaDrag::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickDropAreaDrag.data,
    qt_meta_data_QQuickDropAreaDrag,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickDropArea *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickDropArea::*)(QQuickDropEvent * );
...
QT_INIT_METAOBJECT const QMetaObject QQuickDropArea::staticMetaObject = { {
    &QQuickItem::staticMetaObject,
    qt_meta_stringdata_QQuickDropArea.data,
    qt_meta_data_QQuickDropArea,
    qt_static_metacall,
    nullptr,
    nullptr
} };
