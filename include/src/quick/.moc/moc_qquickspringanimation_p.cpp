...
#include "../util/qquickspringanimation_p.h"
...
void QQuickSpringAnimation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickSpringAnimation *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickSpringAnimation::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickSpringAnimation::staticMetaObject = { {
    &QQuickNumberAnimation::staticMetaObject,
    qt_meta_stringdata_QQuickSpringAnimation.data,
    qt_meta_data_QQuickSpringAnimation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
