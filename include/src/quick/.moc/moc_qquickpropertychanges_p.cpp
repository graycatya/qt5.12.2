...
#include "../util/qquickpropertychanges_p.h"
...
void QQuickPropertyChanges::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<QQuickPropertyChanges *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickPropertyChanges::staticMetaObject = { {
    &QQuickStateOperation::staticMetaObject,
    qt_meta_stringdata_QQuickPropertyChanges.data,
    qt_meta_data_QQuickPropertyChanges,
    qt_static_metacall,
    nullptr,
    nullptr
} };
