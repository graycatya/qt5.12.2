...
#include "../util/qquickstatechangescript_p.h"
...
void QQuickStateChangeScript::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        auto *_t = static_cast<QQuickStateChangeScript *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickStateChangeScript::staticMetaObject = { {
    &QQuickStateOperation::staticMetaObject,
    qt_meta_stringdata_QQuickStateChangeScript.data,
    qt_meta_data_QQuickStateChangeScript,
    qt_static_metacall,
    nullptr,
    nullptr
} };
