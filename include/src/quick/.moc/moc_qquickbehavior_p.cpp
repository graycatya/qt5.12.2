...
#include "../util/qquickbehavior_p.h"
...
void QQuickBehavior::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickBehavior *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickBehavior::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickBehavior.data,
    qt_meta_data_QQuickBehavior,
    qt_static_metacall,
    nullptr,
    nullptr
} };
