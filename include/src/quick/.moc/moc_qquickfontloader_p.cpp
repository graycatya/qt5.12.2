...
#include "../util/qquickfontloader_p.h"
...
void QQuickFontLoader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickFontLoader *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickFontLoader::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickFontLoader::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickFontLoader.data,
    qt_meta_data_QQuickFontLoader,
    qt_static_metacall,
    nullptr,
    nullptr
} };
