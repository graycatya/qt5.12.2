...
#include "../items/qquickshadereffectmesh_p.h"
...
void QQuickShaderEffectMesh::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickShaderEffectMesh *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickShaderEffectMesh::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickShaderEffectMesh::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickShaderEffectMesh.data,
    qt_meta_data_QQuickShaderEffectMesh,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickGridMesh *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickGridMesh::staticMetaObject = { {
    &QQuickShaderEffectMesh::staticMetaObject,
    qt_meta_stringdata_QQuickGridMesh.data,
    qt_meta_data_QQuickGridMesh,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickBorderImageMesh *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QQuickBorderImageMesh::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickBorderImageMesh::staticMetaObject = { {
    &QQuickShaderEffectMesh::staticMetaObject,
    qt_meta_stringdata_QQuickBorderImageMesh.data,
    qt_meta_data_QQuickBorderImageMesh,
    qt_static_metacall,
    nullptr,
    nullptr
} };
