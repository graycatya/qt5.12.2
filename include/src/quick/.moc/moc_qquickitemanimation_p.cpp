...
#include "../items/qquickitemanimation_p.h"
...
void QQuickParentAnimation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickParentAnimation *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickParentAnimation::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickParentAnimation::staticMetaObject = { {
    &QQuickAnimationGroup::staticMetaObject,
    qt_meta_stringdata_QQuickParentAnimation.data,
    qt_meta_data_QQuickParentAnimation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickAnchorAnimation *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QQuickAnchorAnimation::*)(int );
        ...
        {
            using _t = void (QQuickAnchorAnimation::*)(const QEasingCurve & );
...
QT_INIT_METAOBJECT const QMetaObject QQuickAnchorAnimation::staticMetaObject = { {
    &QQuickAbstractAnimation::staticMetaObject,
    qt_meta_stringdata_QQuickAnchorAnimation.data,
    qt_meta_data_QQuickAnchorAnimation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickPathAnimation *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->durationChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->easingChanged((*reinterpret_cast< const QEasingCurve(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QQuickPathAnimation::*)(int );
        ...
        {
            using _t = void (QQuickPathAnimation::*)(const QEasingCurve & );
        ...
        {
            using _t = void (QQuickPathAnimation::*)();
        ...
        {
            using _t = void (QQuickPathAnimation::*)(Orientation );
        ...
        {
            using _t = void (QQuickPathAnimation::*)(const QPointF & );
        ...
        {
            using _t = void (QQuickPathAnimation::*)(qreal );
...
QT_INIT_METAOBJECT const QMetaObject QQuickPathAnimation::staticMetaObject = { {
    &QQuickAbstractAnimation::staticMetaObject,
    qt_meta_stringdata_QQuickPathAnimation.data,
    qt_meta_data_QQuickPathAnimation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
