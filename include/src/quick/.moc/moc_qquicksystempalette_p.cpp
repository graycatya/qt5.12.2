...
#include "../util/qquicksystempalette_p.h"
...
void QQuickSystemPalette::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickSystemPalette *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickSystemPalette::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickSystemPalette::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickSystemPalette.data,
    qt_meta_data_QQuickSystemPalette,
    qt_static_metacall,
    nullptr,
    nullptr
} };
