...
#include "../items/qquickopenglinfo_p.h"
...
void QQuickOpenGLInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickOpenGLInfo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickOpenGLInfo::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickOpenGLInfo::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickOpenGLInfo.data,
    qt_meta_data_QQuickOpenGLInfo,
    qt_static_metacall,
    nullptr,
    nullptr
} };
