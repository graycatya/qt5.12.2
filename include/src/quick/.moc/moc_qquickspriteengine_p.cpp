...
#include "../items/qquickspriteengine_p.h"
...
void QQuickStochasticState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickStochasticState *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickStochasticState::*)(int );
        ...
        {
            using _t = void (QQuickStochasticState::*)(const QString & );
        ...
        {
            using _t = void (QQuickStochasticState::*)(const QVariantMap & );
        ...
        {
            using _t = void (QQuickStochasticState::*)();
        ...
        {
            using _t = void (QQuickStochasticState::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject QQuickStochasticState::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickStochasticState.data,
    qt_meta_data_QQuickStochasticState,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickStochasticEngine *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QQuickStochasticEngine::*)(const QString & );
        ...
        {
            using _t = void (QQuickStochasticEngine::*)(int );
...
QT_INIT_METAOBJECT const QMetaObject QQuickStochasticEngine::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickStochasticEngine.data,
    qt_meta_data_QQuickStochasticEngine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void QQuickSpriteEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<QQuickSpriteEngine *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickSpriteEngine::staticMetaObject = { {
    &QQuickStochasticEngine::staticMetaObject,
    qt_meta_stringdata_QQuickSpriteEngine.data,
    qt_meta_data_QQuickSpriteEngine,
    qt_static_metacall,
    nullptr,
    nullptr
} };
