...
#include "../items/qquickframebufferobject.h"
...
void QQuickFramebufferObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickFramebufferObject *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickFramebufferObject::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject QQuickFramebufferObject::staticMetaObject = { {
    &QQuickItem::staticMetaObject,
    qt_meta_stringdata_QQuickFramebufferObject.data,
    qt_meta_data_QQuickFramebufferObject,
    qt_static_metacall,
    nullptr,
    nullptr
} };
