...
#include "../items/qquickwindow_p.h"
...
void QQuickRootItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickRootItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickRootItem::staticMetaObject = { {
    &QQuickItem::staticMetaObject,
    qt_meta_stringdata_QQuickRootItem.data,
    qt_meta_data_QQuickRootItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
