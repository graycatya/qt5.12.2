...
#include "../items/qquickgenericshadereffect_p.h"
...
void QQuickGenericShaderEffect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickGenericShaderEffect *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickGenericShaderEffect::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickGenericShaderEffect.data,
    qt_meta_data_QQuickGenericShaderEffect,
    qt_static_metacall,
    nullptr,
    nullptr
} };
