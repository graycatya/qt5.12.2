...
#include "../items/qquickpainteditem.h"
...
QT_MOC_LITERAL(17, 263, 16), // "PerformanceHints"
QT_MOC_LITERAL(18, 280, 15), // "PerformanceHint"
QT_MOC_LITERAL(19, 296, 15) // "FastFBOResizing"
    ...
    "FramebufferObject\0InvertedYFramebufferObject\0"
    "PerformanceHints\0PerformanceHint\0"
    "FastFBOResizing"
};
...
static const uint qt_meta_data_QQuickPaintedItem[] = {
 ...
 // enum data: key, value
      ...
      19, uint(QQuickPaintedItem::FastFBOResizing),
...
void QQuickPaintedItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickPaintedItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickPaintedItem::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickPaintedItem::staticMetaObject = { {
    &QQuickItem::staticMetaObject,
    qt_meta_stringdata_QQuickPaintedItem.data,
    qt_meta_data_QQuickPaintedItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
