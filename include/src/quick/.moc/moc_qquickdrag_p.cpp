...
QT_INIT_METAOBJECT const QMetaObject QQuickDragMimeData::staticMetaObject = { {
    &QMimeData::staticMetaObject,
    qt_meta_stringdata_QQuickDragMimeData.data,
    qt_meta_data_QQuickDragMimeData,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void QQuickDrag::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickDrag *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickDrag::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickDrag.data,
    qt_meta_data_QQuickDrag,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickDragAttached *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QQuickDragAttached::*)();
        ...
        {
            using _t = void (QQuickDragAttached::*)(Qt::DropAction );
...
QT_INIT_METAOBJECT const QMetaObject QQuickDragAttached::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickDragAttached.data,
    qt_meta_data_QQuickDragAttached,
    qt_static_metacall,
    qt_meta_extradata_QQuickDragAttached,
    nullptr
} };
