...
#include "../items/qquickitemgrabresult.h"
...
void QQuickItemGrabResult::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickItemGrabResult *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickItemGrabResult::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickItemGrabResult::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickItemGrabResult.data,
    qt_meta_data_QQuickItemGrabResult,
    qt_static_metacall,
    nullptr,
    nullptr
} };
