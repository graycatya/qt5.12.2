...
#include "../util/qquicktextmetrics_p.h"
...
void QQuickTextMetrics::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickTextMetrics *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickTextMetrics::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickTextMetrics::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickTextMetrics.data,
    qt_meta_data_QQuickTextMetrics,
    qt_static_metacall,
    nullptr,
    nullptr
} };
