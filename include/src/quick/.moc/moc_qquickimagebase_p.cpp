...
#include "../items/qquickimagebase_p.h"
...
QT_MOC_LITERAL(15, 205, 6), // "source"
QT_MOC_LITERAL(16, 212, 12), // "asynchronous"
QT_MOC_LITERAL(17, 225, 5), // "cache"
QT_MOC_LITERAL(18, 231, 10), // "sourceSize"
QT_MOC_LITERAL(19, 242, 6), // "mirror"
QT_MOC_LITERAL(20, 249, 4), // "Null"
QT_MOC_LITERAL(21, 254, 5), // "Ready"
QT_MOC_LITERAL(22, 260, 7), // "Loading"
QT_MOC_LITERAL(23, 268, 5) // "Error"
    ...
    "requestProgress\0status\0Status\0source\0"
...
static const uint qt_meta_data_QQuickImageBase[] = {
 ...
 // enum data: key, value
      20, uint(QQuickImageBase::Null),
      21, uint(QQuickImageBase::Ready),
      22, uint(QQuickImageBase::Loading),
      23, uint(QQuickImageBase::Error),
...
void QQuickImageBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickImageBase *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickImageBase::*)(const QUrl & );
        ...
        {
            using _t = void (QQuickImageBase::*)(QQuickImageBase::Status );
        ...
        {
            using _t = void (QQuickImageBase::*)(qreal );
...
QT_INIT_METAOBJECT const QMetaObject QQuickImageBase::staticMetaObject = { {
    &QQuickImplicitSizeItem::staticMetaObject,
    qt_meta_stringdata_QQuickImageBase.data,
    qt_meta_data_QQuickImageBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
