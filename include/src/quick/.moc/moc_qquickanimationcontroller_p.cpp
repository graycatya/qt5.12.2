...
#include "../util/qquickanimationcontroller_p.h"
...
void QQuickAnimationController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickAnimationController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickAnimationController::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickAnimationController::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickAnimationController.data,
    qt_meta_data_QQuickAnimationController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
