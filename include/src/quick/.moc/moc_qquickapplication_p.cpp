...
void QQuickApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickApplication *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickApplication::*)();
        ...
        {
            using _t = void (QQuickApplication::*)(Qt::ApplicationState );
...
QT_INIT_METAOBJECT const QMetaObject QQuickApplication::staticMetaObject = { {
    &QQmlApplication::staticMetaObject,
    qt_meta_stringdata_QQuickApplication.data,
    qt_meta_data_QQuickApplication,
    qt_static_metacall,
    nullptr,
    nullptr
} };
