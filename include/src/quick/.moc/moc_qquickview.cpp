...
void QQuickView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickView::*)(QQuickView::Status );
...
QT_INIT_METAOBJECT const QMetaObject QQuickView::staticMetaObject = { {
    &QQuickWindow::staticMetaObject,
    qt_meta_stringdata_QQuickView.data,
    qt_meta_data_QQuickView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
