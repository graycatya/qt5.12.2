...
#include "../items/qquickshadereffect_p.h"
...
void QQuickShaderEffect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickShaderEffect *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickShaderEffect::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickShaderEffect::staticMetaObject = { {
    &QQuickItem::staticMetaObject,
    qt_meta_stringdata_QQuickShaderEffect.data,
    qt_meta_data_QQuickShaderEffect,
    qt_static_metacall,
    nullptr,
    nullptr
} };
