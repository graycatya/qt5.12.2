...
#include "../items/qquickstateoperations_p.h"
...
void QQuickParentChange::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        auto *_t = static_cast<QQuickParentChange *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickParentChange::staticMetaObject = { {
    &QQuickStateOperation::staticMetaObject,
    qt_meta_stringdata_QQuickParentChange.data,
    qt_meta_data_QQuickParentChange,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void QQuickAnchorSet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        auto *_t = static_cast<QQuickAnchorSet *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickAnchorSet::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickAnchorSet.data,
    qt_meta_data_QQuickAnchorSet,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void QQuickAnchorChanges::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        auto *_t = static_cast<QQuickAnchorChanges *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QQuickItem**>(_v) = _t->object(); break;
...
QT_INIT_METAOBJECT const QMetaObject QQuickAnchorChanges::staticMetaObject = { {
    &QQuickStateOperation::staticMetaObject,
    qt_meta_stringdata_QQuickAnchorChanges.data,
    qt_meta_data_QQuickAnchorChanges,
    qt_static_metacall,
    nullptr,
    nullptr
} };
