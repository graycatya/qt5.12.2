...
#include "../items/qquickspritesequence_p.h"
...
void QQuickSpriteSequence::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickSpriteSequence *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickSpriteSequence::*)(bool );
        ...
        {
            using _t = void (QQuickSpriteSequence::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject QQuickSpriteSequence::staticMetaObject = { {
    &QQuickItem::staticMetaObject,
    qt_meta_stringdata_QQuickSpriteSequence.data,
    qt_meta_data_QQuickSpriteSequence,
    qt_static_metacall,
    nullptr,
    nullptr
} };
