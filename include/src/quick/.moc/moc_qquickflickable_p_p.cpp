...
#include "../items/qquickflickable_p_p.h"
...
void QQuickFlickableVisibleArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickFlickableVisibleArea *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickFlickableVisibleArea::*)(qreal );
...
QT_INIT_METAOBJECT const QMetaObject QQuickFlickableVisibleArea::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickFlickableVisibleArea.data,
    qt_meta_data_QQuickFlickableVisibleArea,
    qt_static_metacall,
    nullptr,
    nullptr
} };
