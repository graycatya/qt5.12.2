...
void QQuickGridLayoutBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickGridLayoutBase *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickGridLayoutBase::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickGridLayoutBase::staticMetaObject = { {
    &QQuickLayout::staticMetaObject,
    qt_meta_stringdata_QQuickGridLayoutBase.data,
    qt_meta_data_QQuickGridLayoutBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickGridLayout *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QQuickGridLayout::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickGridLayout::staticMetaObject = { {
    &QQuickGridLayoutBase::staticMetaObject,
    qt_meta_stringdata_QQuickGridLayout.data,
    qt_meta_data_QQuickGridLayout,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickLinearLayout *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QQuickLinearLayout::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickLinearLayout::staticMetaObject = { {
    &QQuickGridLayoutBase::staticMetaObject,
    qt_meta_stringdata_QQuickLinearLayout.data,
    qt_meta_data_QQuickLinearLayout,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject QQuickRowLayout::staticMetaObject = { {
    &QQuickLinearLayout::staticMetaObject,
    qt_meta_stringdata_QQuickRowLayout.data,
    qt_meta_data_QQuickRowLayout,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject QQuickColumnLayout::staticMetaObject = { {
    &QQuickLinearLayout::staticMetaObject,
    qt_meta_stringdata_QQuickColumnLayout.data,
    qt_meta_data_QQuickColumnLayout,
    qt_static_metacall,
    nullptr,
    nullptr
} };
