...
void QQuickLayout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickLayout *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QQuickLayout::staticMetaObject = { {
    &QQuickItem::staticMetaObject,
    qt_meta_stringdata_QQuickLayout.data,
    qt_meta_data_QQuickLayout,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickLayoutAttached *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickLayoutAttached::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickLayoutAttached::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickLayoutAttached.data,
    qt_meta_data_QQuickLayoutAttached,
    qt_static_metacall,
    nullptr,
    nullptr
} };
