...
void FinalState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FinalState *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject FinalState::staticMetaObject = { {
    &QFinalState::staticMetaObject,
    qt_meta_stringdata_FinalState.data,
    qt_meta_data_FinalState,
    qt_static_metacall,
    nullptr,
    nullptr
} };
