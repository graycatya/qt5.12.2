...
QT_MOC_LITERAL(2, 22, 8), // "children"
QT_MOC_LITERAL(3, 31, 15), // "childrenChanged"
QT_MOC_LITERAL(4, 47, 0), // ""
QT_MOC_LITERAL(5, 48, 25) // "QQmlListProperty<QObject>"

    },
    "State\0DefaultProperty\0children\0"
...
void State::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (State::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&State::childrenChanged)) {
                *result = 0;
                return;
            }
        }
