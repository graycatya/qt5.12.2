...
void TimeoutTransition::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TimeoutTransition *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (TimeoutTransition::*)();
...
QT_INIT_METAOBJECT const QMetaObject TimeoutTransition::staticMetaObject = { {
    &QSignalTransition::staticMetaObject,
    qt_meta_stringdata_TimeoutTransition.data,
    qt_meta_data_TimeoutTransition,
    qt_static_metacall,
    nullptr,
    nullptr
} };
