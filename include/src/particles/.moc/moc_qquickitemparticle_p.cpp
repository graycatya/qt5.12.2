...
void QQuickItemParticle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickItemParticle *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickItemParticle::*)();
        ...
        {
            using _t = void (QQuickItemParticle::*)(QQmlComponent * );
...
QT_INIT_METAOBJECT const QMetaObject QQuickItemParticle::staticMetaObject = { {
    &QQuickParticlePainter::staticMetaObject,
    qt_meta_stringdata_QQuickItemParticle.data,
    qt_meta_data_QQuickItemParticle,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickItemParticleAttached *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (QQuickItemParticleAttached::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQuickItemParticleAttached::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QQuickItemParticleAttached.data,
    qt_meta_data_QQuickItemParticleAttached,
    qt_static_metacall,
    nullptr,
    nullptr
} };
