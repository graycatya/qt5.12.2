...
void QQuickTurbulenceAffector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickTurbulenceAffector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickTurbulenceAffector::*)(qreal );
        ...
        {
            using _t = void (QQuickTurbulenceAffector::*)(QUrl );
...
QT_INIT_METAOBJECT const QMetaObject QQuickTurbulenceAffector::staticMetaObject = { {
    &QQuickParticleAffector::staticMetaObject,
    qt_meta_stringdata_QQuickTurbulenceAffector.data,
    qt_meta_data_QQuickTurbulenceAffector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
