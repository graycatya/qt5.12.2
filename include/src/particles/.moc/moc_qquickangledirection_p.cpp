...
void QQuickAngleDirection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickAngleDirection *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickAngleDirection::*)(qreal );
...
QT_INIT_METAOBJECT const QMetaObject QQuickAngleDirection::staticMetaObject = { {
    &QQuickDirection::staticMetaObject,
    qt_meta_stringdata_QQuickAngleDirection.data,
    qt_meta_data_QQuickAngleDirection,
    qt_static_metacall,
    nullptr,
    nullptr
} };
