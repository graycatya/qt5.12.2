...
void QQuickGravityAffector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickGravityAffector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickGravityAffector::*)(qreal );
...
QT_INIT_METAOBJECT const QMetaObject QQuickGravityAffector::staticMetaObject = { {
    &QQuickParticleAffector::staticMetaObject,
    qt_meta_stringdata_QQuickGravityAffector.data,
    qt_meta_data_QQuickGravityAffector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
