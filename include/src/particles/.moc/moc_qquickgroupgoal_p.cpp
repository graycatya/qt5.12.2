...
void QQuickGroupGoalAffector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickGroupGoalAffector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickGroupGoalAffector::*)(const QString & );
        ...
        {
            using _t = void (QQuickGroupGoalAffector::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject QQuickGroupGoalAffector::staticMetaObject = { {
    &QQuickParticleAffector::staticMetaObject,
    qt_meta_stringdata_QQuickGroupGoalAffector.data,
    qt_meta_data_QQuickGroupGoalAffector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
