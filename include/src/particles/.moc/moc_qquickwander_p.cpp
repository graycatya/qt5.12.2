...
void QQuickWanderAffector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickWanderAffector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickWanderAffector::*)(qreal );
        ...
        {
            using _t = void (QQuickWanderAffector::*)(AffectableParameters );
...
QT_INIT_METAOBJECT const QMetaObject QQuickWanderAffector::staticMetaObject = { {
    &QQuickParticleAffector::staticMetaObject,
    qt_meta_stringdata_QQuickWanderAffector.data,
    qt_meta_data_QQuickWanderAffector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
