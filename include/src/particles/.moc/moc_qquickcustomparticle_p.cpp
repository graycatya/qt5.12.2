...
QT_MOC_LITERAL(6, 87, 14), // "fragmentShader"
QT_MOC_LITERAL(7, 102, 12) // "vertexShader"

    },
    "QQuickCustomParticle\0fragmentShaderChanged\0"
    "\0vertexShaderChanged\0sourceDestroyed\0"
    "object\0fragmentShader\0vertexShader"
};
...
void QQuickCustomParticle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickCustomParticle *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickCustomParticle::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickCustomParticle::fragmentShaderChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (QQuickCustomParticle::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QQuickCustomParticle::vertexShaderChanged)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QQuickCustomParticle::staticMetaObject = { {
    &QQuickParticlePainter::staticMetaObject,
    qt_meta_stringdata_QQuickCustomParticle.data,
    qt_meta_data_QQuickCustomParticle,
    qt_static_metacall,
    nullptr,
    nullptr
} };
