...
void QQuickSpriteGoalAffector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickSpriteGoalAffector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickSpriteGoalAffector::*)(const QString & );
        ...
        {
            using _t = void (QQuickSpriteGoalAffector::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject QQuickSpriteGoalAffector::staticMetaObject = { {
    &QQuickParticleAffector::staticMetaObject,
    qt_meta_stringdata_QQuickSpriteGoalAffector.data,
    qt_meta_data_QQuickSpriteGoalAffector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
