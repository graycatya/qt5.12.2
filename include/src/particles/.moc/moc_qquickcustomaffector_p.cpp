...
void QQuickCustomAffector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickCustomAffector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickCustomAffector::*)(QQmlV4Handle , qreal );
        ...
        {
            using _t = void (QQuickCustomAffector::*)(QQuickDirection * );
        ...
        {
            using _t = void (QQuickCustomAffector::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject QQuickCustomAffector::staticMetaObject = { {
    &QQuickParticleAffector::staticMetaObject,
    qt_meta_stringdata_QQuickCustomAffector.data,
    qt_meta_data_QQuickCustomAffector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
