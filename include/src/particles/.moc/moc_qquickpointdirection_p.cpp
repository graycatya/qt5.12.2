...
void QQuickPointDirection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickPointDirection *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickPointDirection::*)(qreal );
...
QT_INIT_METAOBJECT const QMetaObject QQuickPointDirection::staticMetaObject = { {
    &QQuickDirection::staticMetaObject,
    qt_meta_stringdata_QQuickPointDirection.data,
    qt_meta_data_QQuickPointDirection,
    qt_static_metacall,
    nullptr,
    nullptr
} };
