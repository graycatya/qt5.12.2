...
void QQuickParticlePainter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickParticlePainter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickParticlePainter::*)();
        ...
        {
            using _t = void (QQuickParticlePainter::*)(QQuickParticleSystem * );
        ...
        {
            using _t = void (QQuickParticlePainter::*)(const QStringList & );
...
QT_INIT_METAOBJECT const QMetaObject QQuickParticlePainter::staticMetaObject = { {
    &QQuickItem::staticMetaObject,
    qt_meta_stringdata_QQuickParticlePainter.data,
    qt_meta_data_QQuickParticlePainter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
