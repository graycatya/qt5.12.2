...
void QQuickRectangleExtruder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickRectangleExtruder *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickRectangleExtruder::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject QQuickRectangleExtruder::staticMetaObject = { {
    &QQuickParticleExtruder::staticMetaObject,
    qt_meta_stringdata_QQuickRectangleExtruder.data,
    qt_meta_data_QQuickRectangleExtruder,
    qt_static_metacall,
    nullptr,
    nullptr
} };
