...
void QQuickFrictionAffector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQuickFrictionAffector *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQuickFrictionAffector::*)(qreal );
...
QT_INIT_METAOBJECT const QMetaObject QQuickFrictionAffector::staticMetaObject = { {
    &QQuickParticleAffector::staticMetaObject,
    qt_meta_stringdata_QQuickFrictionAffector.data,
    qt_meta_data_QQuickFrictionAffector,
    qt_static_metacall,
    nullptr,
    nullptr
} };
