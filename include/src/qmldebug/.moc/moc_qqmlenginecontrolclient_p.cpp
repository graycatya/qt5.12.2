...
void QQmlEngineControlClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQmlEngineControlClient *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQmlEngineControlClient::*)(int , const QString & );
...
QT_INIT_METAOBJECT const QMetaObject QQmlEngineControlClient::staticMetaObject = { {
    &QQmlDebugClient::staticMetaObject,
    qt_meta_stringdata_QQmlEngineControlClient.data,
    qt_meta_data_QQmlEngineControlClient,
    qt_static_metacall,
    nullptr,
    nullptr
} };
