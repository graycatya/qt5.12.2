...
void QV4Debugger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QV4Debugger *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QV4Debugger::*)(QV4Debugger * , QV4Debugger::PauseReason );
...
QT_INIT_METAOBJECT const QMetaObject QV4Debugger::staticMetaObject = { {
    &QV4::Debugging::Debugger::staticMetaObject,
    qt_meta_stringdata_QV4Debugger.data,
    qt_meta_data_QV4Debugger,
    qt_static_metacall,
    nullptr,
    nullptr
} };
