...
QT_INIT_METAOBJECT const QMetaObject QmlJSDebugger::InspectTool::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_QmlJSDebugger__InspectTool.data,
    qt_meta_data_QmlJSDebugger__InspectTool,
    qt_static_metacall,
    nullptr,
    nullptr
} };
