...
QT_INIT_METAOBJECT const QMetaObject QmlJSDebugger::Highlight::staticMetaObject = { {
    &QQuickPaintedItem::staticMetaObject,
    qt_meta_stringdata_QmlJSDebugger__Highlight.data,
    qt_meta_data_QmlJSDebugger__Highlight,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject QmlJSDebugger::SelectionHighlight::staticMetaObject = { {
    &Highlight::staticMetaObject,
    qt_meta_stringdata_QmlJSDebugger__SelectionHighlight.data,
    qt_meta_data_QmlJSDebugger__SelectionHighlight,
    qt_static_metacall,
    nullptr,
    nullptr
} };
