...
QT_INIT_METAOBJECT const QMetaObject QDebugMessageServiceFactory::staticMetaObject = { {
    &QQmlDebugServiceFactory::staticMetaObject,
    qt_meta_stringdata_QDebugMessageServiceFactory.data,
    qt_meta_data_QDebugMessageServiceFactory,
    qt_static_metacall,
    nullptr,
    nullptr
} };
