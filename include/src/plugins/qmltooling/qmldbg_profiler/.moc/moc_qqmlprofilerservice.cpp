...
void QQmlProfilerServiceImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QQmlProfilerServiceImpl *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QQmlProfilerServiceImpl::*)();
...
QT_INIT_METAOBJECT const QMetaObject QQmlProfilerServiceImpl::staticMetaObject = { {
    &QQmlConfigurableDebugService<QQmlProfilerService>::staticMetaObject,
    qt_meta_stringdata_QQmlProfilerServiceImpl.data,
    qt_meta_data_QQmlProfilerServiceImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
