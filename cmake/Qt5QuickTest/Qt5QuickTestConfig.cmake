...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5QuickTest" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickTest_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
set(Qt5QuickTest_VERSION_STRING 5.12.2)
...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(_Qt5QuickTest_OWN_INCLUDE_DIRS "${_qt5QuickTest_install_prefix}/include/qt5/" "${_qt5QuickTest_install_prefix}/include/qt5/QtQuickTest")
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/include/qt5/QtQuickTest/5.12.2"
        "${_qt5QuickTest_install_prefix}/include/qt5/QtQuickTest/5.12.2/QtQuickTest"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTest_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.2 ${_Qt5QuickTest_FIND_VERSION_EXACT}
    ...
    _populate_QuickTest_target_properties(RELEASE "libQt5QuickTest.so.5.12.2" "" )
    ...
    macro(_populate_QuickTest_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5QuickTest_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickTest_check_file_exists(${imported_location})
