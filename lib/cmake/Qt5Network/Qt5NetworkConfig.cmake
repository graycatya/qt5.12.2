...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/qt5/QtNetwork/5.12.2"
        "${_qt5Network_install_prefix}/include/qt5/QtNetwork/5.12.2/QtNetwork"
    )
    ...
    _populate_Network_target_properties(RELEASE "libQt5Network.so.5.12.2" "" )
    ...
    macro(_populate_Network_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Network_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_Network_check_file_exists(${imported_location})
