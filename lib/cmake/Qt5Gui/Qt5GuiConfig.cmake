...
set(Qt5Gui_VERSION_STRING 5.12.2)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/qt5/QtGui/5.12.2"
        "${_qt5Gui_install_prefix}/include/qt5/QtGui/5.12.2/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.2 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    _populate_Gui_target_properties(RELEASE "libQt5Gui.so.5.12.2" "" )
    ...
    macro(_populate_Gui_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Gui_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_Gui_check_file_exists(${imported_location})
